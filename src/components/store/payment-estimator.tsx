...
const inputClass =
  'w-full rounded-md border border-ink-300 bg-white px-2.5 py-1.5 text-sm tnum text-ink-900 ' +
  ...
  return (
    <div className="rounded-lg border border-ink-200 bg-ink-50 p-3.5">
      <div className="flex items-baseline justify-between gap-3">
        ...
        <span className="tnum text-xs text-ink-500">{usd(price - safeDown)} financed</span>
      </div>
      ...
      <div className="tnum mt-1 flex items-baseline gap-1.5">
        ...
        <span className="text-sm text-ink-600">/ mo est.</span>
      </div>

      <div className="mt-3 space-y-3">
        <div>
          <div className="flex items-center justify-between">
            <label htmlFor="est-down" className="text-xs font-medium text-ink-700">
              Cash down
            </label>
            <span className="tnum text-xs font-semibold text-ink-900">{usd(safeDown)}</span>
          </div>
          <input
            id="est-down"
            type="range"
        ...
        <div className="grid grid-cols-2 gap-2">
          <div>
            <label htmlFor="est-term" className="mb-1 block text-xs font-medium text-ink-700">
              Term
            </label>
            <select
              id="est-term"
          ...
          <div>
            <label htmlFor="est-apr" className="mb-1 block text-xs font-medium text-ink-700">
              APR
            </label>
            <input
              id="est-apr"
